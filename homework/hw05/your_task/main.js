...
async function getTracks (term) {
   ...
   // console.log(trackData[0]);
    ...
    let counter = 0;
while(counter < 5) {
    const template = `<section class="track-item preview" onclick="playSong('${trackData[counter].id}')">
...
function playSong(id) {
    ...
    <iframe style="border-radius:12px" 
        src="https://open.spotify.com/embed/track/${id}5y8d8RHvxb0KiTa9Nq0xWp?utm_source=generator" 
        width="100%" 
        height="352" 
        frameBorder="0" 
        allowfullscreen="" 
